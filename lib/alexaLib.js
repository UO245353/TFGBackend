  ...
  const handlers = {
    LaunchRequestHandler: {
      ...
      handle(handlerInput) {
        ...
        return Promise.resolve()
        .then(() => handlerInput.attributesManager.setSessionAttributes({stateMachine: removeCircular(new stateMachine(handlerInput.requestEnvelope.session.sessionId))}) )
    ...
    LeeTema: {
      ...
      handle(handlerInput) {
        ...
        return Promise.resolve()
        .then(() => {
          stateMachine = restoreCircular(handlerInput.attributesManager.getSessionAttributes().stateMachine);
