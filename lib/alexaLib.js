...
module.exports = app => {
  ...
  function removeCircular(obj){
    ...
    return require('json-cycle').decycle(obj);
  }

  function restoreCircular(obj){

    return require('json-cycle').retrocycle(obj);
  }
    ...
    LaunchRequestHandler: {
      ...
      handle(handlerInput) {
        ...
        .then(machine => {
          machine.correct();
          machine.back();
          console.log(machine._fsm);
          console.log(Object.keys(machine._fsm));
          machine = removeCircular(machine);
          machine = restoreCircular(machine);
          console.log(machine);
          machine.correct();
          machine.back();
          return handlerInput.attributesManager.setSessionAttributes({stateMachine: removeCircular(machine)});
        })
