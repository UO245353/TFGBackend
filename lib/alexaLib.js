    ...
    HazTest: {
      ...
      handle(handlerInput) {
        ...
        .then(resp => {
          ...
          if(mensaje === alexaResponses.ERROR.NO_QUESTION || mensaje === alexaResponses.ERROR.THEME_NOT_FOUND){
            actualStateMachine.back();
          }
    ...
    RespondePregunta: {
      ...
      handle(handlerInput) {
        ...
        .then(sessionMachine => {
          ...
          return (actualStateMachine.can(alexaTransitions.ANSWER.name)) ? actualStateMachine.answer(responseCharacter) : alexaResponses.IMPOSIBLE_ACTION;
        })
        .catch(err => {
        ...
        .then(resp => {
          ...
          if(mensaje.indexOf('Examen finalizado, has acertado') > -1){
            actualStateMachine.back();
          }
