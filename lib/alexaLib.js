...
module.exports = app => {
  ...
  const alexaResponses = {
    WELCOME: 'Bienvenido a Gestion de Tecnologias de la Informacion',
    HELP: 'Los comandos admitidos son:\nAyuda, que muestra esta ayuda. Leeme o Dictame el tema X. Hazme un examen del tema X. Y dame las soluciones o corrige el tema X. Si tienes dudas con algunos de los comandos puedes pedir ayuda para cada uno de ellos, por ejemplo. Ayudame con Leeme el tema',
    CANCEL: 'Cancelado',
