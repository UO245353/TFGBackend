  ...
  const handlers = {
    LaunchRequestHandler: {
      ...
      handle(handlerInput) {
        ...
        let machineTest = new stateMachine('testId');

        handlerInput.setSessionAttributes({machineTest});
        console.log(machineTest);

        machineTest.dictate('holaaaa');
    ...
    LeeTema: {
      ...
      handle(handlerInput) {
        ...
        console.log(handlerInput.getSessionAttributes());
        return Promise.resolve()
        .then(() => handlerInput.responseBuilder
